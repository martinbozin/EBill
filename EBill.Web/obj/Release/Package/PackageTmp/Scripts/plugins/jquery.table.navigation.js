...
jQuery.tableNavigation = function (settings) {
    ...
    // multiple times from different tableNavigation instances (keydown event will be process x times and therefore
    ...
    * one for clicking on the activation links. A keydown function is also defined which reacts on three
    * keys:
    ...
    */
    function defineInternalEventHandlers() {
        ...
        jQuery.extendedNavigation.internal_event_hanlders.keydown = function (e) {
            if (jQuery.extendedNavigation.settings.disabled) { return }
    ...
    * the first row.
    * 
    * One special note about MSIE: For MSIE the keydown handler will be bound to the keydown
    * event because keydown won't work for some reason.
    * 
    ...
    */
    function bindInternalEventHandlers() {
        ...
        if (jQuery.browser.msie) {
            jQuery(bind_to).keydown(jQuery.extendedNavigation.internal_event_hanlders.keydown);
        } else {
            jQuery(bind_to).keydown(jQuery.extendedNavigation.internal_event_hanlders.keydown);
        }
    };
