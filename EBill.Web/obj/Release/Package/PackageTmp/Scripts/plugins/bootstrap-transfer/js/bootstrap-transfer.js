    ...
    $.fn.bootstrapTransfer = function (options) {
        ...
        return this.each(function () {
            ...
            _this.$add_btn.click(function (e) {
                ...
                if (settings.move_elems_left2right != undefined)
                    if (_this.$remaining_select.val() != null)
                        settings.move_elems_left2right(_this.$remaining_select.val()[0]);
            ...
            _this.$remove_btn.click(function (e) {
                ...
                if (settings.move_elems_right2left != undefined)
                    if (_this.$target_select.val() != null)
                        settings.move_elems_right2left(_this.$target_select.val()[0]);
            ...
            _this.$choose_all_btn.click(function (e) {
                ...
                if (settings.move_all != undefined)
                    settings.move_all();
            ...
            _this.$clear_all_btn.click(function (e) {
                ...
                if (settings.clear_all != undefined)
                    settings.clear_all();
            ...
            _this.$filter_input.keyup(function (e) {
                _this.update_lists(true);
                e.preventDefault();
                return false;
            });
            _this.$remaining_select.dblclick(function (e) {
            ...
            _this.$target_select.dblclick(function (e) {
