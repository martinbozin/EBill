$.widget("NS.RequestFullHistoryWidget", {
    options: {
        templateId: 'request-details-fullhistory',
    },
    _init: function () {
    ...
    load: function (requestDetailsId) {
        var self = this;

        var viewModel = new NS.ViewModels.RequestFullHistoryViewModel();
        viewModel.Init(requestDetailsId);
        ...
        $(this.options.contentElement).dialog({
            ...
            title:  languagePack['Scripts.app.widgets.RequestFullHistoryWidget.js.Title'],
