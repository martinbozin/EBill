$.widget("NS.DefineMunicipalitiesWidget",
{
    options: {
        templateId: 'define-municipalities',
    },
    _init: function () {
    ...
    load: function (extInstitutionId) {

        //Init View Model
        var viewModel = new NS.ViewModels.DefineMunicipalitiesViewModel();
        viewModel.Init(extInstitutionId);
        ...
        $(this.options.contentElement).dialog({
            ...
            title: languagePack['Scripts.app.widgets.DefineMunicipalitiesWidget.js.Title'],
    ...
    _initAplicationUIActions: function () {
        ...
        var t = $('#multiselect', contentElement).bootstrapTransfer(
				{
				    ...
				    move_elems_left2right: function (elem) {
				        viewModel.SelectedMunicipalities.push(elem.toString());
				    },
				    move_elems_right2left: function (elem) {
				        viewModel.SelectedMunicipalities.remove(elem.toString());
				    },
				    move_all: function () {
				        viewModel.SelectedMunicipalities([]);
				        $.map(viewModel.AvailableMunicipalities(), function (item) {
				            viewModel.SelectedMunicipalities.push(item.Value.toString());
				        });
				    },
				    clear_all: function () {
				        viewModel.SelectedMunicipalities([]);
        ...
        t.set_values(viewModel.SelectedMunicipalities());
    },
    destroy: function () {
