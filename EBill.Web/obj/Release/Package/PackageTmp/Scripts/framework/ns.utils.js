    ...
    AJAX: {
        ...
        parseErrorResponse: function (response) {
            if (response.hasOwnProperty('ErrorMessage')) {
                NS.Controls.Dialog.errorDialog('Грешка...', response.ErrorMessage);
                return;
            }
            NS.Controls.Dialog.errorDialog("Грешка ...", response);
        },
        parseErors: function (response, ctx) {
            ...
            if (response.hasOwnProperty('Errors')) {
                ...
                if (errorMessage != "") {
                    NS.Controls.Dialog.errorDialog("Грешка ...", errorMessage);
                }
